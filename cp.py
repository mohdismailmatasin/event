...
def copy_with_progress(src, dst):
    ...
    # If copying a file to a directory, adjust dst
    ...
    try:
        with tqdm(total=total_size, unit='B', unit_scale=True, desc='Copying', ncols=80, bar_format='{l_bar}{bar:30}| {percentage:3.0f}% [{n_fmt}/{total_fmt}, {elapsed}<{remaining}, {rate_fmt}]') as pbar:
